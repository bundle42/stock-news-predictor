...
# 파일 설정
input_file = "NewsResult_20260223-20260324.xlsx"
output_file = "news_sentiment_20260223_20260324.csv"
...
# 전체 뉴스 제목 감정분석
df[["label", "confidence", "sentiment_score"]] = df["제목"].apply(analyze_title)
...
# 필요한 컬럼만 남기기
result_df = df[["date", "title", "label", "confidence", "sentiment_score"]]
